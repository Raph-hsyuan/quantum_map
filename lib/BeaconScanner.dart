...
import 'package:quantum_map/KalmanFilter1D.dart';
                      ...
                      return ListTile(
                        ...
                        subtitle: new Row(
                          ...
                          children: <Widget>[
                            Flexible(
                                child: Text(
                                    'Acc: ${beacon.accuracy}m, Kalman: ${_beaconsCollector[beacon.macAddress + beacon.major.toString() + beacon.minor.toString()].predict(1)}\n',
